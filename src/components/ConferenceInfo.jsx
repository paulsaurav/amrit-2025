  ...
  return (
    <section className="bg-white text-center py-12 px-4">
      <div className="max-w-[1175px] mx-auto">
        ...
        {/* Conference Text */}
        <h2 className="text-blue-600 text-sm md:text-base font-semibold uppercase leading-snug tracking-wide">
          International Conference on Advanced Computing, Machine Learning,<br />
          Robotics and Internet Technologies
        </h2>

        <p className="text-xl font-bold mt-2 text-gray-900">(AMRIT-2023)</p>
        ...
        <div className="text-sm md:text-base leading-relaxed text-gray-800 font-semibold">
          <p>Hybrid Mode</p>

      ...
      <div className="max-w-[1175px] mx-auto flex flex-col gap-12">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-2/3">
            <h2 className="text-xl font-bold mt-2 text-gray-900">BACKGROUND</h2>
          ...
          <div className="w-full md:w-1/3">
            <h2 className="text-xl font-bold mt-2 text-gray-900">EXPECTED OUTCOME</h2>
            <p className='text-gray-800 text-sm font-medium mt-1 text-justify'>The major benefits that are expected may be furnished as below:-</p>
            <ul className="list-disc list-inside space-y-2 text-justify text-sm text-gray-800 mt-2">
        ...
        {/* Row 2: Motivation */}
        <div>
          <h2 className="text-xl font-bold mt-2 text-gray-900">MOTIVATION</h2>
          <p className="text-gray-800 text-sm font-medium mt-1 text-justify">
